(function (w, d) {
    ...
    var Blog = {
        ...
        toc: (function () {
            ...
            var firstAnchor = toc.querySelector('a[href="#' + titles[0].id + '"]') ||
                toc.querySelector('a[href="#' + encodeURIComponent(titles[0].id) + '"]');
            if (firstAnchor) {
                firstAnchor.parentNode.classList.add('active');
            }
            ...
            var firstChild = firstAnchor ? firstAnchor.nextElementSibling : null;
            if (firstChild) {
                ...
                actived: function (top) {
                    for (i = 0, len = titles.length; i < len; i++) {
                        if (top > offset(titles[i]).y - headerH - 5) {
                            ...
                            var titleAnchor = toc.querySelector('a[href="#' + titles[i].id + '"]') ||
                                toc.querySelector('a[href="#' + encodeURIComponent(titles[i].id) + '"]');
                            var currListEle = titleAnchor ? titleAnchor.parentNode : null;
                            if (prevListEle && currListEle) {
                    ...
                    if (top < offset(titles[0]).y) {
                        var prevEle = toc.querySelector('li.active');
                        var currAnchor = toc.querySelector('a[href="#' + titles[0].id + '"]') ||
                            toc.querySelector('a[href="#' + encodeURIComponent(titles[0].id) + '"]');
                        var currEle = currAnchor ? currAnchor.parentNode : null;
                        if (prevEle && currEle) {
                            handleTocActive(prevEle, currEle);
                        }
                    }
                }
            }
